...
const packs = [
  {
    ...
    price: "299€",
    period: "/mes",
    features: ["IA WhatsApp 24/7", "Respuestas automáticas", "Cierre de citas básico"],
    result: "+10% a +20% más citas",
    cta: "Automatizar mi WhatsApp",
    waMsg: "Hola, quiero automatizar mi WhatsApp",
    highlight: false,
  },
  {
    name: "GROWTH",
    ...
    price: "599€",
    period: "/mes",
    features: ["Web optimizada de conversión", "IA WhatsApp + web", "Automatización completa"],
    result: "+20% a +40% más citas",
    cta: "Quiero más pacientes",
    waMsg: "Hola, quiero conseguir más pacientes",
    highlight: true,
  },
  {
    name: "ELITE",
    ...
    period: "/mes",
    features: [
      "Web premium alta conversión",
      "Sistema PatientFlow 24/7™ completo",
      "IA + seguimiento + automatización",
      "Soporte prioritario",
    ],
    result: "+30% a +60% más citas",
    cta: "Activar sistema ahora",
    waMsg: "Hola, quiero activar el sistema completo en mi clínica",
    highlight: false,
  },
];
